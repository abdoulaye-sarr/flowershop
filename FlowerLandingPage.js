    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.featuredSection}>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          <View style={styles.flowerCard}>
            <Image
              source={{ uri: 'https://images.unsplash.com/photo-1508610048659-a06b669e3321?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' }}
              style={styles.flowerImage}
            />
            <Text style={styles.flowerTitle}>Korsa</Text>
          </View>
          <View style={styles.flowerCard}>
            <Image
              source={{ uri: 'https://images.unsplash.com/photo-1444930694458-01babf71870c?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' }}
              style={styles.flowerImage}
            />
            <Text style={styles.flowerTitle}>Kirki</Text>
          </View>
          <View style={styles.flowerCard}>
            <Image
              source={{ uri: 'https://images.unsplash.com/photo-1492950103599-127d2be251b7?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' }}
              style={styles.flowerImage}
            />
            <Text style={styles.flowerTitle}>Tikay</Text>
          </View>
        </ScrollView>
      ...
      <View style={styles.featuredSection}>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          <View style={styles.flowerCard}>
            <Image
              source={{ uri: 'https://images.unsplash.com/photo-1602934585418-f588bea4215c?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' }}
              style={styles.flowerImage}
            />
            <Text style={styles.flowerTitle}>Pitul</Text>
          </View>
          <View style={styles.flowerCard}>
            <Image
              source={{ uri: 'https://images.unsplash.com/photo-1617111490936-07b47eafdcd4?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' }}
              style={styles.flowerImage}
            />
            <Text style={styles.flowerTitle}>Dor</Text>
          </View>
          <View style={styles.flowerCard}>
            <Image
              source={{ uri: 'https://images.unsplash.com/photo-1527061011665-3652c757a4d4?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' }}
              style={styles.flowerImage}
            />
            <Text style={styles.flowerTitle}>Kiri</Text>
          </View>
        </ScrollView>
